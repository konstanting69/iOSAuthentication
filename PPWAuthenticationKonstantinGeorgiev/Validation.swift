...
class Validation {
    //styling function for the fields
    ...
    // button design for filling with green colour
    ...
    // button design for hollow design
...
//structure for constants which might be user more than once
struct Constants {
